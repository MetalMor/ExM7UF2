 ...
 * @author becari
 */
@WebServlet(name = "Navegador", urlPatterns = {"/Navegador"})
public class Navegador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String titol = "Servlets - Exercici08";
        String missatge;
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String pagina = ServletUtilitats.construirPagina(titol, missatge);
            out.println(pagina);
